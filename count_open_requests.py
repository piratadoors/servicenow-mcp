...
from servicenow_mcp.tools.request_tools import count_requests, CountRequestsParams
from servicenow_mcp.utils.config import ServerConfig, AuthConfig, BasicAuthConfig, AuthType
from servicenow_mcp.auth.auth_manager import AuthManager

def main():
    parser = argparse.ArgumentParser(description="Count ServiceNow requests.")
    parser.add_argument("--query", help="ServiceNow encoded query string")
